...
$types = array('all', 'open', 'converted', 'closed');
...
<head>
  ...
  <title><?php echo ucwords($user_group) . " Prospects"; ?> | Prospect Management System</title>
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">View <?php echo ucwords($user_group) . " Prospects"; ?> </li>
        </ol>
        <?php
        ...
        if ($user_group == "all") {
          ...
          $sql = "SELECT * FROM `prospects` WHERE `status` = '$user_group' AND `uid` = '$uid'";
        }
        $result = $conn->query($sql);
        $prospects = array();
        while ($row = $result->fetch_assoc()) {
        ...
        <div class="card mb-3">
          <div class="card-header">
            ...
            if ($user_group == "conve Prospectsted") {
            ?>
            ...
            ?>
            <?php if ($user_group == "all") {
              echo "All Prospects";
            } else {
              echo "All " . ucwords($user_group) . " Prospects";
            } ?></div>
          <div class="card-body">
            <?php
            if (!count($prospects)) {
