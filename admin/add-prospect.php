...
<head>
  ...
  <title>Add Prospect | Prospect Management System</title>
...
<body id="page-top">
  <?php
  if (isset($_POST['submit']) && isset($_POST['name']) && isset($_POST['phone']) && isset($_POST['email']) && isset($_POST['manager'])) {
    $name = $_POST['name'];
    $phone = $_POST['phone'];
    $email = $_POST['email'];
    $manager = $_POST['manager'];
    $sql = "INSERT INTO `prospects` VALUES (NULL, '$name', '$phone', '$email', '$manager', DEFAULT)";
    if ($conn->query($sql)) {
      echo "<script>alert('Prospect Added Successfully!'); window.location.replace('home.php');</script>";
    }
  }
  ?>
        ...
        <div class="card mb-3">
          ...
          <div class="card-body">
            <form method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>">
              <div class="form-row">
                ...
                <div class="form-group col-md-6">
                  ...
                  <select name="manager" id="manager" class="form-control" required>
                    ...
                    <?php
                    $sql = "SELECT * FROM `users` WHERE `access` = 'manager'";
              ...
              <button name="submit" type="submit" class="btn btn-primary">Add Prospect</button>
            </form>
          </div>
        </div>
