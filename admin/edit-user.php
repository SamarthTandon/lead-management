...
<head>
  ...
  <title>Edit User | Prospect Management System</title>
...
<body id="page-top">
  <?php
  if (isset($_POST['submit']) && isset($_POST['name']) && isset($_POST['phone']) && isset($_POST['uid']) && isset($_POST['email']) && isset($_POST['user_group'])) {
    $uid = $_POST['uid'];
    $name = $_POST['name'];
    $phone = $_POST['phone'];
    $email = $_POST['email'];
    $user_group = $_POST['user_group'];
    $sql = "UPDATE `users` SET `name`= '$name', `phone_no`= '$phone', `email`= '$email', `access`= '$user_group'  WHERE `uid` = '$uid'";
    if ($conn->query($sql)) {
            ...
            <form method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>">
              <div class="form-row">
                ...
                <div class="form-group col-md-6">
                  ...
                  <input type="email" class="form-control" required name="email" id="email" value="<?php echo $user['email']; ?>" placeholder="Email">
                </div>
                <div class="form-group col-md-6">
              ...
              <div class="form-row">
                <div class="form-group col-md-6">
                  ...
                  <select name="user_group" id="userGroup" class="form-control" required>
                    ...
                    <option <?php if ($user['access'] == "admin") {
                              echo "selected";
                            } ?> value="admin">Admin</option>
                    <option <?php if ($user['access'] == "manager") {
                              echo "selected";
