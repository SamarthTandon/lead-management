...
<head>
  ...
  <title>Change Password | Prospect Management System</title>
    ...
    <div class="card card-login mx-auto mt-5">
      ...
      <div class="card-body">
        <div class="text-center mb-4">
          <h4>Want to change your password, <?php echo $user['name']; ?>?</h4>
        ...
        <div class="text-center">
          <a class="d-block small" style="text-decoration: none;" href="home.php">Go back</a>
        </div>
      </div>
    </div>
  </div>
